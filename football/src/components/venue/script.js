...
document.querySelectorAll('.heart-btn').forEach(item => {
  item.addEventListener('click', event => {
    ...
    if (btn.src.match("/images/heartregular.svg")) {
      btn.src = "/images/heartsolid.svg";
      var count = 1;
      span.innerHTML = count;
    } else {
      btn.src = "/images/heartregular.svg";
      var count = 0;
      span.innerHTML = count;
    }
